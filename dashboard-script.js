...
function continueStudying(productId) {
    ...
    const htmlGuides = ['heart-failure', 'assessment-skills', 'myocardial-infarction', 'copd', 'stroke', 'gi-bleeding', 'fractures', 'hip-knee-replacement']; // Add more as they're created
