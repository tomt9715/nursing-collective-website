...
const htmlGuides = ['heart-failure', 'assessment-skills', 'myocardial-infarction', 'copd', 'stroke', 'gi-bleeding', 'fractures', 'hip-knee-replacement', 'arrhythmias', 'hypertension', 'coronary-artery-disease', 'peripheral-vascular-disease'];
