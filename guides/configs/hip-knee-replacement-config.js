...
const sidebarConfig = {
    ...
    quickRef: [
        ...
        { type: 'info', icon: 'fa-tooth', value: 'Not routine', label: 'Dental antibiotics', section: 'complications' }
    ],
    clinicalPearls: [
        ...
        { id: 'tip-infection-signs', title: 'Infection can come back', text: 'Fever, rest pain, drainage past day 3 to 5, spreading redness. It can seed years later, so any infection gets reported early.' }
    ]
};
