...
const sidebarConfig = {
    ...
    quickRef: [
        ...
        { type: 'target', icon: 'fa-utensils', value: 'Oatmeal', label: 'Thickener, not rice cereal', section: 'conservative' },
    ...
    clinicalPearls: [
        ...
        { id: 'tip-thicken-feeds', title: 'Oatmeal, Not Rice', text: 'Only if the provider recommends it: oatmeal cereal or a pre-thickened formula, in the amount ordered, with a faster-flow nipple. Never cut the nipple.' },
