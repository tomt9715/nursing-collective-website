    ...
    questions: [
        {
            ...
            options: [
                { id: "a", text: "Arterial disease: warm skin, brown discoloration around the ankles" },
                { id: "b", text: "Venous insufficiency: absent pedal pulses, intermittent claudication" },
                { id: "c", text: "Arterial disease: cool/pale extremity, thin shiny skin, hair loss" },
                { id: "d", text: "Venous insufficiency: rest pain that worsens with leg elevation" }
            ],
            correct: "c",
            rationale: {
                correct: "Peripheral arterial disease (PAD) involves reduced arterial blood flow to the extremities. Classic findings include cool/pale skin (poor perfusion), thin shiny skin, hair loss on the legs, thickened toenails, and diminished or absent pulses. These are all signs of chronic tissue ischemia from inadequate arterial supply.",
                a: "Warm skin and brown discoloration (hemosiderin staining) are characteristics of chronic venous insufficiency (CVI), not peripheral arterial disease (PAD). PAD causes cool, pale skin.",
                b: "Absent pulses and claudication are findings of peripheral arterial disease (PAD), not venous disease. Chronic venous insufficiency (CVI) has palpable pulses because the arterial system is intact.",
        ...
        },
        {
            ...
            stem: "A patient with peripheral arterial disease (PAD) has an ankle-brachial index (ABI) of 0.35. The nurse interprets this result as indicating:",
            options: [
        ...
        },
        {
            ...
            rationale: {
                ...
                c: "ARTERIAL - Intermittent claudication is the hallmark symptom of peripheral arterial disease (PAD). During exercise, muscles demand more oxygen, but narrowed arteries cannot increase supply. Pain is reproducible and relieved by rest.",
        ...
        },
        {
            ...
            options: [
                ...
                { id: "b", text: "Prepare for a STAT computed tomography (CT) pulmonary angiography" },
                { id: "c", text: "Administer sublingual nitroglycerin for chest pain" },
                { id: "d", text: "Apply compression stockings to both legs" }
            ],
            correct: "a",
            rationale: {
                correct: "This presentation - sudden dyspnea, tachycardia, chest pain, and hypoxemia in a post-surgical patient - is classic for pulmonary embolism (PE), the most dangerous complication of deep vein thrombosis (DVT). The immediate priority is oxygenation: elevate the head of the bed to optimize breathing and apply high-flow O2 to address the life-threatening hypoxemia (SpO2 84%).",
                b: "Computed tomography (CT) pulmonary angiography is the gold standard for pulmonary embolism (PE) diagnosis, but stabilizing the patient (airway, breathing, circulation) always comes before diagnostics.",
                c: "Nitroglycerin (NTG) is for cardiac chest pain (angina). Pulmonary embolism (PE) chest pain is caused by a mechanical obstruction, not coronary ischemia. NTG would not help and could cause hypotension.",
                d: "Compression stockings are for deep vein thrombosis (DVT) prevention, not pulmonary embolism (PE) treatment. Applying them during an acute PE event does not address the immediate life threat."
            },
            testTakingTip: "Pulmonary embolism (PE) = sudden onset of the \"3 D's\": Dyspnea, Distress, Desaturation. Post-surgical patients and immobile patients are highest risk. Priority: airway, breathing, circulation (ABCs) first (oxygenate), then diagnose (computed tomography pulmonary angiography), then treat (anticoagulation or thrombolytics).",
        ...
        },
        {
            ...
            correct: "b",
            rationale: {
                correct: "In peripheral arterial disease (PAD), the goal is to promote arterial blood flow TO the ischemic extremities. Keeping legs level or slightly dependent (dangling) uses gravity to assist arterial perfusion. This is the opposite of venous disease positioning.",
                a: "Leg elevation is for VENOUS disease. Elevating legs in peripheral arterial disease (PAD) would further reduce arterial blood flow to already ischemic tissues, worsening pain and tissue damage.",
                c: "Crossing legs compresses both arterial and venous vessels, reducing blood flow. This is harmful for patients with peripheral arterial disease (PAD) and for those with chronic venous insufficiency (CVI).",
                d: "Compression stockings are for VENOUS disease. In peripheral arterial disease (PAD), they would compress already narrowed arteries, further reducing blood flow and potentially causing tissue necrosis."
            },
            testTakingTip: "This is one of the most commonly tested peripheral vascular disease (PVD) concepts: Arterial = legs DOWN (blood needs to get there). Venous = legs UP (blood needs to get back). Mix these up on NCLEX and you\u2019ll get it wrong every time.",
        ...
        },
        {
            ...
            subtype: null,
            difficulty: "application",
            stem: "A patient on heparin therapy for deep vein thrombosis (DVT) has the following lab results: activated partial thromboplastin time (aPTT) 120 seconds (therapeutic range 60-80 seconds), platelets 58,000/mm\u00B3 (baseline 210,000). The nurse should FIRST:",
            options: [
                ...
                { id: "d", text: "Reduce the heparin rate by 50% and recheck activated partial thromboplastin time (aPTT) in 2 hours" }
            ],
            correct: "b",
            labValues: [
            ...
            rationale: {
                correct: "This patient shows two critical findings: a supratherapeutic activated partial thromboplastin time (aPTT) of 120 seconds, well above the 60-80 range, AND a platelet drop >50% from baseline (210,000 \u2192 58,000). The platelet drop strongly suggests heparin-induced thrombocytopenia (HIT) - a life-threatening immune reaction. Heparin must be stopped IMMEDIATELY and the provider notified. HIT paradoxically causes thrombosis, not bleeding.",
                a: "Continuing heparin with suspected heparin-induced thrombocytopenia (HIT) and supratherapeutic activated partial thromboplastin time (aPTT) is dangerous and could cause fatal thrombosis.",
                c: "Protamine sulfate reverses heparin\u2019s anticoagulant effect but does not treat heparin-induced thrombocytopenia (HIT). The priority is stopping the heparin and notifying the provider, who will order alternative anticoagulation (e.g., argatroban).",
                d: "Dose reduction is inadequate. With suspected heparin-induced thrombocytopenia (HIT), ALL heparin products must be completely discontinued - not just reduced."
            },
            testTakingTip: "Heparin-induced thrombocytopenia (HIT) red flags: Platelet drop >50% from baseline, typically 5-10 days after starting heparin. Remember: HIT causes CLOTS (not bleeding) despite low platelets. Stop ALL heparin (including flushes). Antidote for heparin = protamine. Antidote for warfarin = vitamin K.",
            guideSection: "Section 8 - Treatment & Nursing Care",
            guideSectionId: "interventions"
        },
        {
            ...
            subtype: null,
            difficulty: "analysis",
            stem: "A patient with peripheral arterial disease has a dry, non-healing ulcer on the dorsum of the foot with an ankle-brachial index (ABI) of 0.5. Place the wound care priorities in the correct order.",
            options: [
            ...
            rationale: {
                ...
                e: "FIFTH - Aggressive debridement of ischemic tissue is dangerous without adequate perfusion. Defer until after revascularization restores blood flow (typically an ankle-brachial index above 0.7)."
            },
            testTakingTip: "Peripheral arterial disease (PAD) wounds: ASSESS \u2192 FIX THE PLUMBING \u2192 POSITION \u2192 PROTECT \u2192 DON'T HARM. Arterial ulcers = keep DRY; venous ulcers = keep MOIST. Never apply compression dressings to arterial wounds.",
            guideSection: "Section 8 - Treatment & Nursing Care",
            guideSectionId: "interventions"
        },
        {
            ...
            subtype: "priority",
            difficulty: "analysis",
            stem: "A patient with peripheral arterial disease (PAD) reports a sudden onset of severe leg pain with a cold, pale, pulseless left foot. The nurse recognizes this as acute arterial occlusion. What is the priority nursing action?",
            options: [
                ...
                { id: "d", text: "Prepare the patient for an ankle-brachial index measurement" }
            ],
            correct: "b",
            rationale: {
                ...
                d: "Ankle-brachial index (ABI) is a non-emergent diagnostic tool. In acute arterial occlusion, time is tissue - the priority is immediate provider notification and preparation for emergent intervention."
            },
