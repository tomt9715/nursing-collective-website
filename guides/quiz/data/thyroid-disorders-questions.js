...
var thyroidDisordersQuizData = {
    ...
    questions: [
        ...
        // Q1 - Feedback Loop Basics (Knowledge, Single)
        {
            ...
            stem: "A nursing student asks, \"Why does thyroid-stimulating hormone (TSH) go UP when the thyroid is failing?\" Which response by the nurse BEST explains this relationship?",
            options: [
                { id: "a", text: "The thyroid gland directly stimulates the pituitary to produce more thyroid-stimulating hormone (TSH) when it cannot keep up with demand." },
                { id: "b", text: "When T3 and T4 levels drop, the hypothalamus and pituitary lose negative feedback inhibition and increase thyrotropin-releasing hormone (TRH) and thyroid-stimulating hormone (TSH) secretion." },
                { id: "c", text: "Thyroid-stimulating hormone (TSH) rises because the adrenal glands release cortisol in response to low thyroid hormone levels." },
                { id: "d", text: "High thyroid-stimulating hormone (TSH) is a compensatory response triggered by the kidneys detecting low metabolic rate." }
            ],
            correct: "b",
            rationale: {
                correct: "The thyroid axis operates on a negative feedback loop. When T3/T4 levels fall, there is less inhibition of the hypothalamus and anterior pituitary. The hypothalamus increases thyrotropin-releasing hormone (TRH), which stimulates the pituitary to increase thyroid-stimulating hormone (TSH) - essentially 'calling louder' for the thyroid to produce more hormone.",
                ...
                c: "The adrenal glands and cortisol are not part of the hypothalamic-pituitary-thyroid axis. Cortisol can affect thyroid binding proteins but does not drive thyroid-stimulating hormone (TSH) elevation.",
                d: "The kidneys do not regulate thyroid-stimulating hormone (TSH). The feedback loop is confined to the hypothalamus → pituitary → thyroid axis."
            },
            testTakingTip: "Think of thyroid-stimulating hormone (TSH) as the pituitary 'yelling' at the thyroid. When T3/T4 drop, the pituitary yells louder (TSH rises). When T3/T4 are high, the pituitary whispers (TSH falls).",
        ...
        // Q2 - Thyroid Storm Emergency (Application, Ordering)
        {
            ...
            options: [
                ...
                { id: "b", text: "Administer high-dose antithyroid medication, preferably propylthiouracil (PTU), to block new thyroid hormone synthesis" },
                ...
                { id: "e", text: "Administer iodine solution, either saturated solution of potassium iodide (SSKI) or Lugol\u2019s, at least 1 hour AFTER antithyroid medication to block hormone release" }
            ],
            correct: ["a", "b", "c", "d", "e"],
            rationale: {
                ...
                b: "SECOND - Propylthiouracil (PTU) is preferred over methimazole in thyroid storm because it both blocks new hormone synthesis AND inhibits peripheral T4-to-T3 conversion. This must be given BEFORE iodine.",
                ...
                e: "FIFTH - Iodine, given as saturated solution of potassium iodide (SSKI) or Lugol\u2019s, blocks the release of preformed thyroid hormone via the Wolff-Chaikoff effect. It MUST be given at least 1 hour after propylthiouracil (PTU) - if given first, the thyroid would use the iodine to make MORE hormone, worsening the crisis."
            },
            testTakingTip: "Thyroid storm priority: Beta-blocker first (HR kills), then propylthiouracil (PTU), then steroids, then cooling, then iodine LAST (and only after antithyroid meds). Remember: aspirin is contraindicated in thyroid storm because it increases free T4. The iodine timing rule is heavily tested on NCLEX.",
            guideSection: "Section 1 - Thyroid Physiology",
            guideSectionId: "physiology"
        },
        ...
        // Q3 - Primary Hypothyroidism Labs (Knowledge, Single)
        {
            ...
            subtype: null,
            difficulty: "knowledge",
            stem: "A patient's lab results show thyroid-stimulating hormone (TSH) 18.6 mIU/L (normal: 0.4–4.0) and free T4 0.3 ng/dL (normal: 0.8–1.8). Which condition do these results MOST likely indicate?",
            options: [
            ...
            correct: "c",
            rationale: {
                correct: "High thyroid-stimulating hormone (TSH) + low free T4 = primary hypothyroidism. The thyroid gland itself is failing (low T4 output), so the pituitary compensates by producing more TSH to try to stimulate the gland. TSH moves in the OPPOSITE direction of thyroid hormone levels.",
                a: "Hyperthyroidism would show LOW thyroid-stimulating hormone (TSH) and HIGH T3/T4. The pituitary suppresses TSH when excess thyroid hormone is present.",
                b: "In secondary (central) hypothyroidism, the problem is at the pituitary level, so thyroid-stimulating hormone (TSH) would be LOW or inappropriately normal despite low T4. Here, TSH is significantly elevated.",
                d: "Subclinical hyperthyroidism shows low thyroid-stimulating hormone (TSH) with NORMAL T4/T3 levels. This patient has high TSH and low T4 - the opposite pattern."
            },
            testTakingTip: "Thyroid-stimulating hormone (TSH) goes OPPOSITE of thyroid function. High TSH = hypothyroid (pituitary is 'yelling' at a failing thyroid). Low TSH = hyperthyroid (pituitary is 'shutting up' because there's too much hormone).",
        ...
        // Q4 - Hyperthyroid Labs (Knowledge, Single)
        {
            ...
            subtype: null,
            difficulty: "knowledge",
            stem: "A patient presents with unintentional weight loss, tremors, and palpitations. Lab results reveal thyroid-stimulating hormone (TSH) 0.05 mIU/L (normal: 0.4–4.0) and free T4 4.8 ng/dL (normal: 0.8–1.8). How should the nurse interpret these results?",
            options: [
                { id: "a", text: "The labs are consistent with hypothyroidism; the pituitary is not producing enough thyroid-stimulating hormone (TSH)." },
                { id: "b", text: "The labs are consistent with hyperthyroidism; excess T4 is suppressing thyroid-stimulating hormone (TSH) through negative feedback." },
                { id: "c", text: "The labs indicate a pituitary tumor producing excess thyroid-stimulating hormone (TSH) and T4." },
                { id: "d", text: "The results are inconclusive; a free T3 level is needed before any interpretation." }
            ],
            correct: "b",
            rationale: {
                correct: "Low thyroid-stimulating hormone (TSH) + high free T4 is the hallmark of primary hyperthyroidism. The thyroid is overproducing T4, and the elevated T4 feeds back to the pituitary and hypothalamus, suppressing TSH production. The symptoms (weight loss, tremors, palpitations) are consistent with a hypermetabolic state.",
                a: "Low thyroid-stimulating hormone (TSH) with HIGH T4 does not indicate hypothyroidism. In hypothyroidism, T4 would be low and TSH would be elevated. The low TSH here is due to negative feedback from excess thyroid hormone.",
                c: "A pituitary adenoma secreting thyroid-stimulating hormone (TSH) would show high TSH AND high T4. Here, TSH is suppressed, which is the normal feedback response to excess thyroid hormone from a primary thyroid source.",
                d: "While free T3 can add clinical information, low thyroid-stimulating hormone (TSH) + elevated free T4 combined with classic hyperthyroid symptoms provides a clear diagnosis. Waiting for additional labs would delay appropriate care."
            },
            testTakingTip: "Always pair thyroid-stimulating hormone (TSH) with T4 for interpretation: High TSH + Low T4 = hypo. Low TSH + High T4 = hyper. When they move in opposite directions, it's a PRIMARY thyroid disorder.",
            guideSection: "Section 2 - Lab Value Interpretation",
            guideSectionId: "lab-values"
        },
        ...
        // Q5 - Subclinical Hypothyroidism (Application, Single)
        {
            ...
            subtype: null,
            difficulty: "application",
            stem: "A patient's annual labs show thyroid-stimulating hormone (TSH) 7.2 mIU/L (normal: 0.4–4.0) with a free T4 of 1.0 ng/dL (normal: 0.8–1.8). The patient reports mild fatigue but no other symptoms. Which interpretation should the nurse provide to the patient?",
            options: [
                { id: "a", text: "\"Your labs are completely normal. The fatigue is likely from stress, so no follow-up testing is needed.\"" },
                { id: "b", text: "\"You have subclinical hypothyroidism. Your thyroid-stimulating hormone (TSH) is elevated but your T4 is still normal, so we will monitor closely.\"" },
            ...
            correct: "b",
            rationale: {
                correct: "Subclinical hypothyroidism is defined by an elevated thyroid-stimulating hormone (TSH) with normal free T4. The pituitary is already working harder to maintain normal hormone levels, but the thyroid is beginning to fail. Close monitoring is appropriate because it may progress to overt hypothyroidism, especially if anti-thyroid peroxidase (TPO) antibodies are present.",
                a: "The thyroid-stimulating hormone (TSH) is elevated, so the labs are NOT normal. Dismissing the abnormal TSH would miss an early warning sign of thyroid dysfunction.",
                c: "This is not severe hypothyroidism. The free T4 is still within normal range. Severe hypothyroidism would show markedly low T4 with very high thyroid-stimulating hormone (TSH) and significant symptoms.",
                d: "An elevated thyroid-stimulating hormone (TSH) indicates the thyroid is UNDERactive, not overactive. If the thyroid were overactive, TSH would be suppressed (low)."
            },
            testTakingTip: "Subclinical = thyroid-stimulating hormone (TSH) abnormal but T4 still normal. Think of it as the 'early warning stage' - the pituitary is compensating, but the thyroid is starting to struggle.",
            guideSection: "Section 2 - Lab Value Interpretation",
            guideSectionId: "lab-values"
        },
        ...
        // Q6 - T3 vs T4 Understanding (Knowledge, Single)
        {
            ...
            rationale: {
                ...
                c: "Both T3 and T4 are produced by the thyroid gland. The pituitary produces thyroid-stimulating hormone (TSH), not thyroid hormones. A small amount of T3 is also produced by peripheral conversion of T4.",
        ...
        // Q7 - Lab Interpretation Matrix (Analysis, Matrix)
        {
            ...
            options: [
                { id: "a", text: "Thyroid-stimulating hormone (TSH) elevated above 4.0 mIU/L" },
                { id: "b", text: "Free T4 below 0.8 ng/dL" },
                { id: "c", text: "Thyroid-stimulating hormone (TSH) suppressed below 0.4 mIU/L" },
            ...
            rationale: {
                correct: "In primary hypothyroidism, thyroid-stimulating hormone (TSH) rises (pituitary compensation), T4 drops, and cholesterol increases due to slowed lipid metabolism. In primary hyperthyroidism, TSH is suppressed by excess hormone, and T3/T4 levels are elevated.",
                a: "PRIMARY HYPOTHYROIDISM - Elevated thyroid-stimulating hormone (TSH) is the hallmark of primary hypothyroidism. The pituitary increases TSH output to stimulate the failing thyroid gland.",
                ...
                c: "PRIMARY HYPERTHYROIDISM - Thyroid-stimulating hormone (TSH) is suppressed because the excess thyroid hormone (from the thyroid itself) provides strong negative feedback to the pituitary.",
                ...
                e: "PRIMARY HYPOTHYROIDISM - Hypothyroidism slows lipid metabolism, reducing low-density lipoprotein (LDL) receptor activity and leading to elevated total cholesterol and LDL. This is a commonly overlooked finding."
            },
        ...
        // Q8 - TSH Monitoring Timing (Application, Single)
        {
            ...
            subtype: null,
            difficulty: "application",
            stem: "A patient with newly diagnosed hypothyroidism started levothyroxine 50 mcg daily 2 weeks ago. The patient calls the clinic asking when to recheck thyroid-stimulating hormone (TSH) levels. What is the nurse's BEST response?",
            options: [
                { id: "a", text: "\"Come in today so we can check if the medication is working.\"" },
                { id: "b", text: "\"We typically recheck your thyroid-stimulating hormone (TSH) in 6 to 8 weeks after starting or changing the dose.\"" },
                { id: "c", text: "\"Your thyroid-stimulating hormone (TSH) should be rechecked in 6 months at your next annual physical.\"" },
                { id: "d", text: "\"You only need to recheck thyroid-stimulating hormone (TSH) if you develop new symptoms.\"" }
            ],
            correct: "b",
            rationale: {
                correct: "Thyroid-stimulating hormone (TSH) should be rechecked 6-8 weeks after starting levothyroxine or after any dose change. It takes this long for TSH to reach a new steady state after the thyroid hormone level changes. Checking too early gives inaccurate results and may lead to inappropriate dose adjustments.",
                a: "Checking thyroid-stimulating hormone (TSH) at 2 weeks is too early. Levothyroxine has a long half-life (~7 days), and TSH takes 6-8 weeks to stabilize. An early TSH may still be elevated, leading to an unnecessary dose increase.",
                ...
                d: "Thyroid-stimulating hormone (TSH) should be monitored on a schedule, not only when symptoms occur. Thyroid dysfunction can be detected by TSH changes before symptoms develop, allowing for proactive dose adjustment."
            },
            testTakingTip: "6-8 weeks is the magic number for thyroid-stimulating hormone (TSH) rechecks after any levothyroxine dose change. Think: '6-8 weeks to steady state.' Once stable, recheck every 6-12 months.",
            guideSection: "Section 2 - Lab Value Interpretation",
            guideSectionId: "lab-values"
        },
        ...
        // Q9 - Iodine and Thyroid Function (Knowledge, Single)
        {
            ...
            options: [
                { id: "a", text: "Iodine is needed for the pituitary gland to produce thyroid-stimulating hormone (TSH), which then signals the thyroid to make hormone." },
            ...
            rationale: {
                ...
                a: "Iodine is needed by the THYROID gland to produce T3 and T4, not by the pituitary to produce thyroid-stimulating hormone (TSH). TSH is a glycoprotein hormone that does not require iodine.",
                b: "In the United States, iodine deficiency is rare due to iodized salt. The most common cause of hypothyroidism there is Hashimoto's thyroiditis (autoimmune). Iodine deficiency is the most common cause worldwide.",
            ...
            testTakingTip: "Iodine deficiency = #1 cause of hypothyroidism WORLDWIDE. Hashimoto's = #1 cause in the United States. This distinction is high-yield for NCLEX. Remember: T4 has 4 iodines, T3 has 3.",
            guideSection: "Section 1 - Thyroid Physiology",
            guideSectionId: "physiology"
        },
        ...
        // Q10 - Interpreting Secondary Hypothyroidism (Analysis, Single)
        {
            ...
            subtype: null,
            difficulty: "analysis",
            stem: "A patient with a history of pituitary surgery presents with fatigue and cold intolerance. Lab results show thyroid-stimulating hormone (TSH) 0.8 mIU/L (normal: 0.4–4.0) and free T4 0.4 ng/dL (normal: 0.8–1.8). Which interpretation is MOST accurate?",
            options: [
                { id: "a", text: "The patient has primary hypothyroidism; the thyroid-stimulating hormone (TSH) should be higher, so the thyroid gland itself is failing." },
                { id: "b", text: "The labs are normal because thyroid-stimulating hormone (TSH) is within the reference range, so no further thyroid evaluation is needed." },
                { id: "c", text: "The patient likely has secondary (central) hypothyroidism; the damaged pituitary cannot mount an appropriate thyroid-stimulating hormone (TSH) response." },
                { id: "d", text: "The low T4 is likely due to a lab error since the thyroid-stimulating hormone (TSH) is normal; the test should simply be repeated." }
            ],
            correct: "c",
            rationale: {
                ...
                a: "If this were primary hypothyroidism, thyroid-stimulating hormone (TSH) should indeed be much higher (often >10) in response to such a low T4. The fact that TSH is 'normal' despite low T4 points to pituitary dysfunction, not thyroid dysfunction.",
                b: "While thyroid-stimulating hormone (TSH) falls within the reference range numerically, it is INAPPROPRIATELY normal given the low T4. In a healthy axis, this T4 level would trigger a much higher TSH. Clinical context (pituitary surgery) is essential for interpretation.",
            ...
            testTakingTip: "Secondary hypothyroidism trap: Thyroid-stimulating hormone (TSH) looks 'normal' but T4 is low. The key is the TSH is INAPPROPRIATELY normal - a functioning pituitary would raise TSH much higher. Always consider pituitary history.",
            guideSection: "Section 2 - Lab Value Interpretation",
            guideSectionId: "lab-values"
        },
        ...
        // Q11 - Hypothyroidism Signs/Symptoms (Knowledge, Single)
        {
            ...
            correct: "b",
            rationale: {
                correct: "Hypothyroidism causes everything to SLOW DOWN: heart rate decreases (bradycardia), metabolism drops (weight gain despite poor appetite), gastrointestinal (GI) motility slows (constipation), and thermoregulation is impaired (cold intolerance). Think 'slow and low' for hypothyroidism.",
        ...
        // Q12 - Hashimoto's Pathophysiology (Knowledge, Single)
        {
            ...
            correct: "b",
            rationale: {
                correct: "Hashimoto's thyroiditis is an autoimmune disorder where the immune system produces anti-thyroid peroxidase (TPO) and anti-thyroglobulin antibodies. These antibodies cause chronic inflammation and progressive destruction of thyroid tissue, eventually leading to hypothyroidism. It is the most common cause of hypothyroidism in the United States.",
                ...
                c: "This describes Graves' disease, where thyroid-stimulating immunoglobulins (TSI) activate thyroid-stimulating hormone (TSH) receptors and cause hyperthyroidism. Hashimoto's antibodies destroy the thyroid rather than stimulate it.",
                d: "Thyroid tumors/nodules are a separate entity. Hashimoto's involves diffuse autoimmune destruction, not tumor compression."
            },
            testTakingTip: "Hashimoto's = autoimmune DESTRUCTION (hypo). Graves' = autoimmune STIMULATION (hyper). Both are autoimmune, but the antibodies do opposite things. Anti-thyroid peroxidase (TPO) antibodies are the marker for Hashimoto's.",
            guideSection: "Section 3 - Hypothyroidism",
            guideSectionId: "hypothyroidism"
        },
        ...
        // Q13 - Hypothyroidism Causes Matrix (Application, Matrix)
        {
            ...
            rationale: {
                ...
                a: "CAN CAUSE HYPOTHYROIDISM - Lithium inhibits thyroid hormone synthesis and release. Up to 20-30% of patients on lithium develop thyroid dysfunction. Regular thyroid-stimulating hormone (TSH) monitoring is essential.",
                ...
                c: "DOES NOT CAUSE HYPOTHYROIDISM - Metformin is an oral antidiabetic that may lower thyroid-stimulating hormone (TSH) slightly but does not cause clinically significant hypothyroidism. It is not associated with thyroid dysfunction.",
                d: "CAN CAUSE HYPOTHYROIDISM - Radioactive iodine (I-131) destroys thyroid tissue by design. Most patients treated with radioactive iodine (RAI) for hyperthyroidism eventually develop hypothyroidism and require lifelong levothyroxine.",
                e: "CAN CAUSE HYPOTHYROIDISM - Hashimoto's thyroiditis is the #1 cause of hypothyroidism in the United States. Autoimmune anti-thyroid peroxidase (TPO) antibodies progressively destroy thyroid tissue."
            },
            testTakingTip: "Key medications causing hypothyroidism: Lithium, Amiodarone, Interferon-alpha, and radioactive iodine (RAI). Remember Lithium, Amiodarone, Interferon, Radioactive iodine (LAIR). If a patient on these develops fatigue/weight gain, check thyroid-stimulating hormone (TSH).",
            guideSection: "Section 3 - Hypothyroidism",
            guideSectionId: "hypothyroidism"
        },
        ...
        // Q14 - Hypothyroidism vs Hyperthyroidism Matrix (Analysis, Matrix)
        {
            ...
            rationale: {
                correct: "Hypothyroidism slows everything: metabolism (cold intolerance), skin turnover (dry skin), reflexes (delayed), fluid clearance (edema), and causes heavy menses. Hyperthyroidism speeds everything up: gastrointestinal (GI) transit (diarrhea), metabolism (weight loss), nervous system (tremors, anxiety, insomnia).",
                ...
                b: "HYPERTHYROIDISM - Increased metabolic rate causes weight loss even with increased caloric intake. Increased gastrointestinal (GI) motility causes diarrhea or frequent bowel movements.",
        ...
        // Q15 - Levothyroxine Empty Stomach (Application, Single)
        {
            ...
            correct: "b",
            rationale: {
                correct: "Food, particularly fiber, calcium-containing dairy products, and soy, significantly reduces levothyroxine absorption by binding to the medication in the gastrointestinal (GI) tract. Studies show food can reduce bioavailability by up to 40-80%. Taking it on an empty stomach 30-60 minutes before breakfast ensures optimal and consistent absorption.",
                ...
                c: "Levothyroxine does not cause stomach ulcers and does not need to be taken with food for gastrointestinal (GI) protection. This is not a nonsteroidal anti-inflammatory drug (NSAID).",
        ...
        // Q16 - Levothyroxine-Warfarin Interaction (Analysis, Single)
        {
            ...
            options: [
                { id: "a", text: "International normalized ratio (INR) of 4.2 (target range 2.0–3.0)" },
                { id: "b", text: "Blood pressure of 128/78 mmHg, similar to prior visits" },
                { id: "c", text: "Resting heart rate of 72 bpm on today's vital signs" },
                { id: "d", text: "Thyroid-stimulating hormone (TSH) of 6.8 mIU/L (target: 0.4–4.0)" }
            ],
            correct: "a",
            rationale: {
                correct: "Levothyroxine INCREASES the anticoagulant effect of warfarin by increasing catabolism of vitamin K-dependent clotting factors. An international normalized ratio (INR) of 4.2 is significantly above the therapeutic range (2.0-3.0), putting the patient at risk for serious bleeding. The warfarin dose may need to be decreased, and INR should be monitored more frequently when starting levothyroxine.",
                ...
                d: "While thyroid-stimulating hormone (TSH) is still mildly elevated, this is a dosing concern (the levothyroxine dose may need to be increased), not an immediate safety concern like the supratherapeutic international normalized ratio (INR)."
            },
            testTakingTip: "Levothyroxine + warfarin = increased bleeding risk. When starting levothyroxine in a patient on warfarin, expect to DECREASE the warfarin dose and increase international normalized ratio (INR) monitoring frequency.",
        ...
        // Q18 - Levothyroxine Overdose Signs (Application, Single)
        {
            ...
            options: [
                ...
                { id: "b", text: "Advise the patient to hold the levothyroxine, report symptoms to the provider, and come in for thyroid lab work." },
            ...
            correct: "b",
            rationale: {
                correct: "Palpitations, tremors, insomnia, and weight loss are signs of hyperthyroidism - suggesting the levothyroxine dose is too high. The nurse should advise the patient to hold the medication, notify the provider for possible dose reduction, and obtain a thyroid-stimulating hormone (TSH) level to confirm. These symptoms indicate the patient is receiving more thyroid hormone than needed.",
                ...
                d: "Taking levothyroxine with food to slow absorption is not an appropriate solution for overreplacement. The dose needs to be adjusted by the provider based on thyroid-stimulating hormone (TSH) levels."
            },
        ...
        // Q19 - Levothyroxine in Elderly (Analysis, Single)
        {
            ...
            options: [
                ...
                { id: "c", text: "Start with a high dose and taper down once thyroid-stimulating hormone (TSH) normalizes." },
            ...
            rationale: {
                ...
                a: "A full replacement dose in an elderly cardiac patient could be dangerous. Rapidly increasing metabolic rate increases cardiac workload and oxygen demand, potentially causing myocardial infarction (MI) or arrhythmias in an already compromised heart.",
        ...
        // Q20 - Levothyroxine Patient Teaching Matrix (Analysis, Matrix)
        {
            ...
            options: [
                ...
                { id: "b", text: "\"My thyroid-stimulating hormone (TSH) is normal now, so my doctor said I can stop taking the levothyroxine.\"" },
            ...
            rationale: {
                correct: "Taking levothyroxine on an empty stomach with water (A) and separating iron by several hours (D) show correct understanding. Stopping medication when thyroid-stimulating hormone (TSH) normalizes (B), switching brands without notifying the provider (C), and doubling doses (E) all indicate misunderstanding of therapy.",
                ...
                b: "NEEDS MORE TEACHING - Normal thyroid-stimulating hormone (TSH) means the medication IS WORKING, not that the condition is cured. Hypothyroidism (especially from Hashimoto's) requires lifelong therapy. Stopping medication will cause TSH to rise and symptoms to return.",
                c: "NEEDS MORE TEACHING - Different levothyroxine brands have different bioavailability despite containing the same dose. Switching brands can alter thyroid hormone levels and may require thyroid-stimulating hormone (TSH) monitoring and dose adjustment. The provider must be notified.",
        ...
        // Q21 - Hypothyroidism and Cholesterol (Application, Single)
        {
            ...
            subtype: null,
            difficulty: "application",
            stem: "A 55-year-old patient presents for a routine physical. Labs reveal a total cholesterol of 278 mg/dL and low-density lipoprotein (LDL) of 192 mg/dL. The patient has been compliant with diet and exercise. Before starting a statin, the nurse practitioner orders which additional test?",
            options: [
                { id: "a", text: "Hemoglobin A1C level" },
                { id: "b", text: "Thyroid-stimulating hormone level" },
                { id: "c", text: "Liver function panel" },
                { id: "d", text: "High-sensitivity C-reactive protein" }
            ],
            correct: "b",
            rationale: {
                correct: "Hypothyroidism is a reversible cause of hyperlipidemia. Decreased thyroid hormone reduces low-density lipoprotein (LDL) receptor activity, slowing cholesterol clearance and elevating total cholesterol and LDL. Checking thyroid-stimulating hormone (TSH) before starting a statin is important because treating hypothyroidism with levothyroxine may normalize cholesterol without the need for a statin.",
                ...
                d: "C-reactive protein (CRP) is an inflammatory marker used for cardiovascular risk stratification. While useful, it would not identify the underlying cause of elevated cholesterol in this scenario."
            },
        ...
        // Q22 - Hypothyroidism Assessment Ordering (Application, Ordering)
        {
            ...
            options: [
                ...
                { id: "c", text: "Anticipate and obtain thyroid-stimulating hormone (TSH) and free T4 labs as ordered" },
            ...
            rationale: {
                ...
                c: "THIRD - Thyroid-stimulating hormone (TSH) and free T4 are the confirmatory tests. Labs are obtained after assessment data supports the clinical suspicion.",
        ...
        // Q23 - Levothyroxine Contraindications (Analysis, Single)
        {
            ...
            correct: "b",
            rationale: {
                correct: "Recent or acute myocardial infarction (MI) is a relative contraindication for initiating levothyroxine, especially at standard doses. Thyroid hormone increases heart rate, myocardial contractility, and oxygen demand - all of which would worsen myocardial ischemia. Treatment should be delayed or started at extremely low doses (12.5 mcg) once the cardiac event is stabilized.",
                a: "A full replacement dose would significantly increase cardiac workload and oxygen demand, potentially extending the myocardial infarction (MI) or causing fatal arrhythmias. This is the opposite of safe management.",
                c: "IV T3 acts even faster than T4 and would be MORE dangerous in the setting of acute myocardial infarction (MI). Rapid thyroid hormone replacement with an active cardiac event is contraindicated.",
                d: "Cardiac medications are critical during an acute myocardial infarction (MI). Thyroid management must be balanced with cardiac care, not substituted for it."
            },
            testTakingTip: "Recent myocardial infarction (MI) = delay or minimize levothyroxine. The heart cannot handle the increased workload. Also remember: untreated adrenal insufficiency is the OTHER major contraindication (give corticosteroids first).",
            guideSection: "Section 7 - Thyroid Medications",
            guideSectionId: "medications"
        },
        ...
        // Q24 - Hypothyroidism in Pregnancy (Application, Single)
        {
            ...
            testTakingTip: "Levothyroxine in pregnancy: CONTINUE and expect to INCREASE dose by 25-50%. Untreated maternal hypothyroidism → fetal brain damage. Monitor thyroid-stimulating hormone (TSH) every 4 weeks in 1st trimester.",
            guideSection: "Section 3 - Hypothyroidism",
            guideSectionId: "hypothyroidism"
        },
        ...
        // Q25 - Hypothyroidism Neurological Effects (Knowledge, Single)
        {
            ...
            testTakingTip: "New-onset depression or cognitive decline → always check thyroid-stimulating hormone (TSH). Hypothyroidism is a reversible cause of depression and 'pseudodementia,' especially in older adults. Treat the thyroid first before adding psychotropics.",
            guideSection: "Section 3 - Hypothyroidism",
            guideSectionId: "hypothyroidism"
        },
        ...
        // Q26 - Hashimoto's Antibodies (Knowledge, Single)
        {
            ...
            options: [
                ...
                { id: "b", text: "Anti-thyroid peroxidase (TPO) antibodies" },
                { id: "c", text: "Anti-nuclear antibodies (ANA)" },
                { id: "d", text: "Anti-smooth muscle antibodies" }
            ],
            correct: "b",
            rationale: {
                correct: "Anti-thyroid peroxidase (TPO) antibodies are the hallmark serologic marker of Hashimoto's thyroiditis. Present in approximately 90-95% of patients, these antibodies target thyroid peroxidase, an enzyme essential for thyroid hormone synthesis. Anti-thyroglobulin antibodies may also be elevated. Their presence confirms the autoimmune etiology.",
                a: "Thyroid-stimulating immunoglobulins (TSI) are the hallmark of Graves' disease, not Hashimoto's. TSI stimulates the thyroid (causing hyperthyroidism), while anti-thyroid peroxidase (TPO) antibodies destroy it (causing hypothyroidism).",
                c: "Antinuclear antibody (ANA) is associated with systemic lupus erythematosus and other systemic autoimmune conditions, not specifically with Hashimoto's thyroiditis.",
                d: "Anti-smooth muscle antibodies are associated with autoimmune hepatitis, not thyroid disease."
            },
            testTakingTip: "Hashimoto's marker = anti-thyroid peroxidase (TPO) antibodies (destruction). Graves' marker = thyroid-stimulating immunoglobulin (TSI) antibodies (stimulation). Both are autoimmune, but the antibody type determines whether the thyroid is destroyed or overstimulated.",
            guideSection: "Section 3 - Hypothyroidism",
            guideSectionId: "hypothyroidism"
        },
        ...
        // Q27 - Levothyroxine Brand Consistency (Application, Single)
        {
            ...
            options: [
                ...
                { id: "b", text: "\"Notify your provider about the brand change. You may need a thyroid blood test in 6-8 weeks to ensure the new formulation maintains your levels.\"" },
            ...
            correct: "b",
            rationale: {
                correct: "Different levothyroxine formulations can have variations in bioavailability even at the same dose. The Food and Drug Administration (FDA) considers levothyroxine a narrow therapeutic index drug. Brand changes can result in subtle but clinically significant differences in absorption, potentially causing hypo- or hyperthyroid symptoms. The provider should be notified, and thyroid-stimulating hormone (TSH) should be rechecked in 6-8 weeks.",
            ...
            testTakingTip: "Levothyroxine = narrow therapeutic index. Brand switches require provider notification and thyroid-stimulating hormone (TSH) recheck in 6-8 weeks. This applies to any change: brand to generic, generic to brand, or generic to generic.",
            guideSection: "Section 7 - Thyroid Medications",
            guideSectionId: "medications"
        },
        ...
        // Q28 - Levothyroxine Teaching Priorities Ordering (Application, Ordering)
        {
            ...
            correct: ["a", "b", "c", "d", "e"],
            rationale: {
                correct: "Safety-critical information comes first: (1) Recognizing cardiac danger signs prevents life-threatening complications. (2) Daily adherence and proper administration ensure therapeutic effect. (3) Drug interaction avoidance prevents subtherapeutic levels. (4) Medical alert identification ensures proper emergency care. (5) Expectation setting, while important, is least critical for safety.",
        ...
        // Q31 - Myxedema Coma Recognition (Analysis, Single - Priority)
        {
            ...
            options: [
                { id: "a", text: "Thyroid storm; administer propylthiouracil (PTU) and beta-blockers immediately and apply a cooling blanket." },
            ...
            rationale: {
                ...
                c: "While blood glucose should be checked (myxedema coma can cause hypoglycemia), the overall presentation with hypothermia, bradycardia, and hypothyroid history points to myxedema coma rather than diabetic ketoacidosis (DKA). DKA typically presents with tachycardia, Kussmaul respirations, and hyperglycemia.",
        ...
        // Q32 - Myxedema Coma Triggers Matrix (Knowledge, Matrix)
        {
            ...
            rationale: {
                ...
                a: "KNOWN TRIGGER - Infection is the most common precipitant of myxedema coma. Pneumonia and urinary tract infection (UTI) are leading triggers because the body's metabolic demand increases but the hypothyroid state prevents appropriate response.",
                b: "KNOWN TRIGGER - Sedatives, opioids, and anesthesia further suppress the already-depressed central nervous system (CNS) and respiratory drive in hypothyroid patients, potentially tipping them into myxedema coma.",
        ...
        // Q34 - Myxedema Coma Treatment Ordering (Analysis, Ordering)
        {
            ...
            rationale: {
                ...
                c: "THIRD - IV levothyroxine (loading dose) is the definitive treatment. IV route is essential because gastrointestinal (GI) absorption is severely impaired. Oral levothyroxine cannot be used in an unresponsive patient.",
            ...
            testTakingTip: "Myxedema coma treatment priority: airway, breathing, circulation (ABC) → Steroids BEFORE thyroid hormone → IV levothyroxine → Passive rewarming → Metabolic correction. The steroid-before-T4 rule is NCLEX gold.",
            guideSection: "Section 4 - Myxedema Coma",
            guideSectionId: "myxedema-coma"
        },
        ...
        // Q35 - Myxedema Coma Electrolytes (Application, Single)
        {
            ...
            options: [
                ...
                { id: "b", text: "Impaired free water excretion due to decreased cardiac output and increased antidiuretic hormone (ADH) secretion." },
            ...
            correct: "b",
            rationale: {
                correct: "Hyponatremia in myxedema coma is dilutional. Severe hypothyroidism decreases cardiac output and renal perfusion, impairing the kidney's ability to excrete free water. Additionally, antidiuretic hormone (ADH), also called vasopressin, secretion is increased. The result is water retention that dilutes serum sodium. Treatment is fluid restriction, not sodium replacement.",
            ...
            testTakingTip: "Myxedema coma hyponatremia = dilutional (too much water, not too little sodium). Treatment = fluid RESTRICTION. This is the same mechanism as syndrome of inappropriate antidiuretic hormone (SIADH). Don't give more fluids - restrict them.",
            guideSection: "Section 4 - Myxedema Coma",
            guideSectionId: "myxedema-coma"
        },
        ...
        // Q37 - Myxedema vs Thyroid Storm Matrix (Analysis, Matrix)
        {
            ...
            rationale: {
                ...
                f: "THYROID STORM - Central nervous system (CNS) hyperexcitability from excess thyroid hormone causes agitation progressing to delirium and psychosis. Myxedema coma causes the opposite: lethargy progressing to coma."
            },
        ...
        // Q38 - Myxedema Coma IV vs Oral Levothyroxine (Knowledge, Single)
        {
            ...
            options: [
                ...
                { id: "c", text: "Gastrointestinal (GI) absorption is severely impaired in myxedema coma due to decreased motility and mucosal edema, and the patient may be unable to swallow safely." },
            ...
            correct: "c",
            rationale: {
                correct: "In myxedema coma, the gastrointestinal (GI) tract is severely affected by the hypothyroid state: motility is profoundly decreased, mucosal edema impairs absorption, and the patient is typically unresponsive and cannot safely swallow oral medication (aspiration risk). IV administration bypasses these barriers and ensures reliable drug delivery.",
                a: "While IV does have a more predictable onset and aspiration avoidance is relevant, the primary clinical rationale is impaired gastrointestinal (GI) absorption. Even if the patient could swallow, oral absorption would be unreliable.",
                b: "Oral levothyroxine is not categorically contraindicated in all emergencies. In less severe acute hypothyroidism where the patient is alert and gastrointestinal (GI) function is intact, oral dosing may be acceptable. The specific impairment in myxedema coma necessitates IV.",
                d: "IV and oral levothyroxine contain the same active molecule (synthetic T4). The IV formulation is not inherently more potent - the advantage is reliable delivery that bypasses the compromised gastrointestinal (GI) tract."
            },
        ...
        // Q39 - Myxedema Coma Fluid Management (Analysis, Single)
        {
            ...
            options: [
                ...
                { id: "d", text: "Dextrose 5% in water (D5W) at a maintenance rate to correct hyponatremia." }
            ],
            correct: "c",
            rationale: {
                ...
                d: "Dextrose 5% in water (D5W) is a hypotonic solution that would WORSEN the hyponatremia by providing free water without sodium. The hyponatremia in myxedema coma is dilutional - the patient needs less water, not more."
            },
        ...
        // Q41 - Hyperthyroidism Signs (Knowledge, Single)
        {
            ...
            correct: "b",
            rationale: {
                correct: "This is a classic hyperthyroid presentation: tachycardia, weight loss despite increased appetite, diarrhea/frequent stools, and heat intolerance. Excess thyroid hormone increases metabolic rate, sympathetic nervous system activity, and gastrointestinal (GI) motility - everything speeds up.",
            ...
            testTakingTip: "Hyperthyroidism = everything FAST and HIGH: fast heart, fast metabolism (weight loss), fast gastrointestinal (GI) transit (diarrhea), fast nervous system (anxiety/tremors). If a patient is losing weight while eating more - think thyroid.",
        ...
        // Q42 - Graves' Disease Pathophysiology (Knowledge, Single)
        {
            ...
            options: [
                ...
                { id: "c", text: "A pituitary adenoma that secretes excess thyroid-stimulating hormone (TSH), overstimulating the thyroid gland." },
                { id: "d", text: "Chronic iodine excess from dietary sources and supplements that overstimulates thyroid hormone synthesis." }
            ],
            correct: "b",
            rationale: {
                correct: "Graves' disease is an autoimmune condition where the immune system produces thyroid-stimulating immunoglobulins (TSI) that bind to and activate thyroid-stimulating hormone (TSH) receptors on thyroid cells. This mimics TSH stimulation but is unregulated - the thyroid continuously produces hormone regardless of feedback signals. It is the most common cause of hyperthyroidism.",
                ...
                c: "A pituitary adenoma that secretes thyroid-stimulating hormone (TSH), called a TSHoma, is a rare cause of secondary hyperthyroidism. In Graves' disease, TSH is actually SUPPRESSED because the stimulation comes from thyroid-stimulating immunoglobulin (TSI), not TSH.",
            ...
            testTakingTip: "Graves' = autoimmune STIMULATION: thyroid-stimulating immunoglobulin (TSI) mimics thyroid-stimulating hormone (TSH). Hashimoto's = autoimmune DESTRUCTION: anti-thyroid peroxidase (TPO) antibodies attack the thyroid. Both autoimmune, opposite results. Graves' is the #1 cause of hyperthyroidism.",
            guideSection: "Section 5 - Hyperthyroidism",
            guideSectionId: "hyperthyroidism"
        },
        ...
        // Q43 - Exophthalmos Assessment (Application, Single)
        {
            ...
            correct: "b",
            rationale: {
                correct: "Exophthalmos (proptosis) in Graves' disease exposes the cornea due to incomplete eyelid closure. Corneal drying, ulceration, and infection are serious complications that can lead to vision loss. Key interventions include artificial tears (lubrication), elevating the head of bed (HOB) 30-45° to reduce periorbital edema, and taping eyelids at night to protect corneas during sleep.",
                a: "Levothyroxine is for hypothyroidism, not hyperthyroidism. Graves' disease requires antithyroid medications such as methimazole or propylthiouracil (PTU), not thyroid replacement. Additionally, exophthalmos may not improve even after hyperthyroidism is treated.",
            ...
            testTakingTip: "Exophthalmos priority = CORNEAL PROTECTION. The eyes can't close fully → cornea dries out → ulceration → vision loss. Artificial tears + elevate head of bed (HOB) + tape lids at night. Important: exophthalmos may persist even after thyroid is treated.",
            guideSection: "Section 5 - Hyperthyroidism",
            guideSectionId: "hyperthyroidism"
        },
        ...
        // Q44 - Hyperthyroidism Cardiac Complications (Analysis, Single)
        {
            ...
            testTakingTip: "New-onset atrial fibrillation (especially in older adults with no cardiac history) → always check thyroid-stimulating hormone (TSH). Hyperthyroidism is a reversible cause of A-fib. Beta-blockers are preferred over digoxin for rate control in thyrotoxicosis.",
            guideSection: "Section 5 - Hyperthyroidism",
            guideSectionId: "hyperthyroidism"
        },
        ...
        // Q45 - Hyperthyroidism vs Hypothyroidism GI Matrix (Analysis, Matrix)
        {
            ...
            rationale: {
                correct: "Gastrointestinal (GI) manifestations directly reflect metabolic rate: hypothyroidism slows metabolism (weight gain, decreased appetite, constipation, elevated cholesterol) while hyperthyroidism accelerates it (weight loss, increased appetite, diarrhea). The appetite-weight mismatch is a key differentiator.",
                ...
                c: "HYPOTHYROIDISM - Decreased gastrointestinal (GI) motility from slowed metabolism causes constipation and reduced bowel sounds. Severe cases can cause paralytic ileus.",
                d: "HYPERTHYROIDISM - Increased gastrointestinal (GI) motility causes frequent, loose stools (not typically true diarrhea) and hyperactive bowel sounds. Malabsorption may contribute to weight loss.",
                e: "HYPOTHYROIDISM - Slowed lipid metabolism decreases low-density lipoprotein (LDL) receptor activity, reducing cholesterol clearance and elevating serum levels. This often improves with levothyroxine treatment."
            },
        ...
        // Q47 - Hyperthyroidism Causes (Knowledge, Single)
        {
            ...
            correct: "c",
            rationale: {
                correct: "Graves' disease accounts for approximately 60-80% of all cases of hyperthyroidism, making it the most common cause. It is an autoimmune disorder caused by thyroid-stimulating immunoglobulins (TSI) that activate thyroid-stimulating hormone (TSH) receptors. It is more common in women and often has a genetic predisposition.",
                ...
                b: "Iatrogenic hyperthyroidism (from levothyroxine overdose) can occur but is not the most common cause. It is usually detected through routine thyroid-stimulating hormone (TSH) monitoring and dose adjustment.",
            ...
            testTakingTip: "Most common cause of HYPERthyroidism = Graves' disease (autoimmune stimulation). Most common cause of HYPOthyroidism in the United States = Hashimoto's (autoimmune destruction). Both autoimmune, both most common for their respective condition.",
            guideSection: "Section 5 - Hyperthyroidism",
            guideSectionId: "hyperthyroidism"
        },
        ...
        // Q49 - Comprehensive Thyroid Comparison Ordering (Analysis, Ordering)
        {
            ...
            options: [
                { id: "a", text: "Subclinical hypothyroidism: elevated thyroid-stimulating hormone (TSH), normal T4, minimal symptoms" },
                { id: "b", text: "Overt hypothyroidism: elevated thyroid-stimulating hormone (TSH), low T4, classic symptoms of fatigue, weight gain, cold intolerance" },
                { id: "c", text: "Severe hypothyroidism: markedly elevated thyroid-stimulating hormone (TSH), very low T4, significant functional impairment" },
            ...
            correct: ["a", "b", "c", "d", "e"],
            rationale: {
                correct: "Myxedema coma represents the end stage of a progressive decline: (1) Subclinical stage - the thyroid is starting to fail but T4 is maintained through increased thyroid-stimulating hormone (TSH), (2) Overt hypothyroidism - T4 drops and classic symptoms appear, (3) Severe hypothyroidism - marked hormone deficiency with significant impairment, (4) A trigger event pushes the body beyond its ability to compensate, (5) Myxedema coma - complete metabolic decompensation.",
                a: "FIRST - The earliest detectable stage. The pituitary is working harder, raising thyroid-stimulating hormone (TSH), to maintain normal T4. The patient may have no or minimal symptoms.",
        ...
        // Q50 - Hyperthyroidism Diagnosis (Application, Single)
        {
            ...
            options: [
                { id: "a", text: "Thyroid-stimulating hormone (TSH) 8.4 mIU/L (high), free T4 0.5 ng/dL (low)" },
                { id: "b", text: "Thyroid-stimulating hormone (TSH) 0.02 mIU/L (low), free T4 5.2 ng/dL (high)" },
                { id: "c", text: "Thyroid-stimulating hormone (TSH) 2.1 mIU/L (normal), free T4 1.2 ng/dL (normal)" },
                { id: "d", text: "Thyroid-stimulating hormone (TSH) 0.3 mIU/L (low-normal), free T4 0.9 ng/dL (normal)" }
            ],
            correct: "b",
            rationale: {
                correct: "The lab pattern for primary hyperthyroidism is LOW thyroid-stimulating hormone (TSH) + HIGH free T4. The thyroid is overproducing hormone (high T4), and the excess feeds back to the pituitary, suppressing TSH to very low levels. This is the mirror image of primary hypothyroidism (high TSH + low T4).",
                a: "This pattern of high thyroid-stimulating hormone (TSH) + low T4 indicates primary HYPOthyroidism, the opposite of what the question asks. The thyroid is failing, and the pituitary is compensating with more TSH.",
                c: "Normal thyroid-stimulating hormone (TSH) and T4 indicate euthyroid (normal thyroid function). These results would not explain the patient's hyperthyroid symptoms, which might suggest an alternative diagnosis.",
                d: "This pattern could represent subclinical hyperthyroidism, meaning slightly low thyroid-stimulating hormone (TSH) with normal T4, or could be normal. The TSH is at the lower end of normal, and T4 is normal - this does not confirm hyperthyroidism."
            },
            testTakingTip: "Lab pattern summary: Primary Hypo = ↑thyroid-stimulating hormone (TSH) ↓T4. Primary Hyper = ↓TSH ↑T4. TSH always goes OPPOSITE of the thyroid problem. When in doubt on the exam, check whether TSH and T4 move in opposite directions.",
            guideSection: "Section 2 - Lab Value Interpretation",
            guideSectionId: "lab-values"
        },
        ...
        // Q51 - Graves' Triad (Knowledge, Single)
        {
            ...
            options: [
                ...
                { id: "d", text: "Elevated thyroid-stimulating hormone (TSH), low T4, and cold intolerance" }
            ],
            correct: "b",
            rationale: {
                ...
                d: "Elevated thyroid-stimulating hormone (TSH) with low T4 and cold intolerance are signs of hypothyroidism - the opposite of Graves' disease."
            },
        ...
        // Q52 - Graves' Eye Care (Application, Single)
        {
            ...
            testTakingTip: "Graves' eye care: Lubricate (artificial tears) + Protect (sunglasses) + Elevate (head of bed) + Tape (lids at night). Important: exophthalmos may be PERMANENT even after thyroid treatment.",
            guideSection: "Section 5 - Hyperthyroidism",
            guideSectionId: "hyperthyroidism"
        },
        ...
        // Q54 - Thyroid Nodule Evaluation (Application, Single)
        {
            ...
            options: [
                { id: "a", text: "Computed tomography (CT) scan of the neck with contrast" },
            ...
            rationale: {
                ...
                a: "Computed tomography (CT) scan can assess the size and extent of a nodule but cannot differentiate benign from malignant tissue. CT with iodinated contrast should actually be avoided if radioactive iodine (RAI) treatment might be needed, as it can interfere with radioactive iodine uptake.",
                ...
                d: "While radioactive iodine (RAI) scans can identify 'hot' (functioning) vs 'cold' (non-functioning) nodules, a cold nodule only indicates increased risk - it doesn't provide a tissue diagnosis. Fine-needle aspiration (FNA) is needed for definitive evaluation."
            },
            testTakingTip: "Thyroid nodule evaluation: Fine-needle aspiration (FNA) biopsy is the gold standard. 'Cold' nodules on radioactive iodine (RAI) scan = higher cancer risk (don't take up iodine). 'Hot' nodules = usually benign. But only FNA gives a definitive tissue diagnosis.",
            guideSection: "Section 8 - Goiter & Nodules",
            guideSectionId: "goiter-nodules"
        },
        ...
        // Q55 - Thyroid Cancer Risk Factors Matrix (Analysis, Matrix)
        {
            ...
            options: [
                ...
                { id: "e", text: "Family history of thyroid cancer or multiple endocrine neoplasia (MEN) syndrome" },
            ...
            rationale: {
                correct: "Childhood radiation, cold nodules, hard/fixed/rapidly growing nodules, and family history of thyroid cancer or multiple endocrine neoplasia (MEN) syndrome all increase cancer risk. Soft/mobile nodules and hot nodules are more likely benign.",
                ...
                e: "INCREASED RISK - Family history of thyroid cancer, especially medullary thyroid cancer associated with multiple endocrine neoplasia (MEN) syndrome, significantly increases risk.",
            ...
            testTakingTip: "Thyroid cancer red flags: Cold nodule, Hard/fixed, Irradiation history, Rapid growth, Positive family history (CHIRP). Hot nodules are almost always benign.",
            guideSection: "Section 8 - Goiter & Nodules",
            guideSectionId: "goiter-nodules"
        },
        ...
        // Q56 - Goiter Types and Causes (Knowledge, Single)
        {
            ...
            testTakingTip: "Goiter worldwide = iodine deficiency. Goiter in the United States = Hashimoto's (autoimmune). Key difference: iodized salt eliminated endemic goiter in developed countries but remains a global issue.",
            guideSection: "Section 8 - Goiter & Nodules",
            guideSectionId: "goiter-nodules"
        },
        ...
        // Q58 - Graves' TSI Antibodies (Knowledge, Single)
        {
            ...
            subtype: null,
            difficulty: "knowledge",
            stem: "A patient with Graves' disease asks why the thyroid keeps making too much hormone even though thyroid-stimulating hormone (TSH) is very low. Which explanation by the nurse is MOST accurate?",
            options: [
                { id: "a", text: "\"Your thyroid gland has a benign tumor (toxic adenoma) that produces hormone independently of thyroid-stimulating hormone (TSH).\"" },
                { id: "b", text: "\"Your immune system makes antibodies that mimic thyroid-stimulating hormone (TSH) and keep stimulating the thyroid, regardless of the feedback loop.\"" },
                { id: "c", text: "\"Your pituitary gland is producing too much thyroid-stimulating hormone (TSH), which overstimulates the thyroid and overrides the feedback loop.\"" },
                { id: "d", text: "\"You are consuming too much dietary iodine, which forces the thyroid to make excess hormone on its own.\"" }
            ],
            correct: "b",
            rationale: {
                correct: "In Graves' disease, the immune system produces thyroid-stimulating immunoglobulins (TSI) that bind to and activate thyroid-stimulating hormone (TSH) receptors on thyroid cells. Unlike TSH, TSI is NOT regulated by the negative feedback loop. Even though high T3/T4 levels suppress TSH to near-zero, TSI continues to stimulate the thyroid, causing unrelenting hormone production.",
                ...
                c: "In Graves' disease, thyroid-stimulating hormone (TSH) is actually SUPPRESSED (very low) because the excess thyroid hormone provides strong negative feedback. The stimulation comes from thyroid-stimulating immunoglobulin (TSI), not TSH.",
                d: "While dietary iodine provides substrate for hormone synthesis, it does not drive the overproduction in Graves'. The fundamental problem is the thyroid-stimulating immunoglobulin (TSI) antibody that bypasses normal regulatory mechanisms."
            },
            testTakingTip: "Why does Graves' bypass feedback? Thyroid-stimulating immunoglobulin (TSI) mimics thyroid-stimulating hormone (TSH) but the pituitary can't turn it off. Even with TSH near zero, TSI keeps stimulating. The thyroid can't tell the difference between TSH and TSI.",
            guideSection: "Section 5 - Hyperthyroidism",
            guideSectionId: "hyperthyroidism"
        },
        ...
        // Q59 - Graves' Treatment Options (Application, Single)
        {
            ...
            options: [
                ...
                { id: "b", text: "Methimazole therapy now, switching to propylthiouracil (PTU) for the first trimester of pregnancy, then back to methimazole for the second and third trimesters." },
            ...
            correct: "b",
            rationale: {
                correct: "For a woman planning pregnancy, antithyroid medications are the preferred approach. Methimazole is used until pregnancy is confirmed, then switched to propylthiouracil (PTU) during the first trimester (methimazole is teratogenic in early pregnancy). After the first trimester, methimazole can be resumed because PTU carries a higher risk of hepatotoxicity (black box warning).",
                a: "Radioactive iodine (RAI) is contraindicated in women planning pregnancy within 6-12 months. RAI destroys thyroid tissue and requires a waiting period before conception. If already pregnant, RAI would destroy the fetal thyroid.",
            ...
            testTakingTip: "Pregnancy + hyperthyroidism drug rule: Methimazole normally → switch to propylthiouracil (PTU) in 1st trimester → switch back to methimazole in 2nd/3rd. Radioactive iodine (RAI) = ABSOLUTELY contraindicated if pregnant or planning pregnancy within 6-12 months.",
            guideSection: "Section 7 - Thyroid Medications",
            guideSectionId: "medications"
        },
        ...
        // Q60 - Hot vs Cold Nodule (Knowledge, Single)
        {
            ...
            correct: "b",
            rationale: {
                correct: "A 'cold' nodule does not concentrate radioactive iodine, meaning it is non-functioning (not producing thyroid hormone). About 5-10% of cold nodules are malignant. While most cold nodules are still benign, they require further evaluation with fine-needle aspiration (FNA) biopsy to rule out cancer. A 'hot' nodule takes up iodine and is almost always benign.",
                ...
                d: "A cold nodule on a radioactive iodine (RAI) scan is a diagnostic finding, not a response to treatment. It indicates the nodule is not participating in iodine uptake or hormone production."
            },
        ...
        // Q61 - Methimazole Mechanism (Knowledge, Single)
        {
            ...
            testTakingTip: "Antithyroid drug mechanisms: Methimazole/propylthiouracil (PTU) = block SYNTHESIS. Lugol's iodine = block RELEASE. PTU has the bonus of also blocking peripheral T4→T3 conversion (why it's preferred in thyroid storm).",
            guideSection: "Section 7 - Thyroid Medications",
            guideSectionId: "medications"
        },
        ...
        // Q62 - Agranulocytosis Warning (Application, Single)
        {
            ...
            correct: "b",
            rationale: {
                correct: "Sore throat, fever, and mouth ulcers in a patient on antithyroid medication such as methimazole or propylthiouracil (PTU) are classic warning signs of agranulocytosis - a life-threatening reduction in white blood cells. The medication must be stopped immediately and a complete blood count (CBC) with differential obtained urgently. Agranulocytosis occurs in 0.1-0.5% of patients, most commonly in the first 3 months. Without prompt recognition, it can be fatal from overwhelming infection.",
            ...
            testTakingTip: "Antithyroid drug + sore throat + fever = AGRANULOCYTOSIS until proven otherwise. Stop the drug, get a STAT complete blood count (CBC). This is the #1 tested antithyroid drug side effect on NCLEX. Peak risk: first 3 months.",
            guideSection: "Section 7 - Thyroid Medications",
            guideSectionId: "medications"
        },
        ...
        // Q63 - PTU Black Box Warning (Knowledge, Single)
        {
            ...
            correct: "b",
            rationale: {
                correct: "Propylthiouracil (PTU) carries a Food and Drug Administration (FDA) Black Box Warning for severe hepatotoxicity, including cases of acute liver failure, liver transplantation, and death. This is the primary reason methimazole is now the preferred first-line antithyroid drug. PTU is reserved for first trimester pregnancy (where methimazole is teratogenic) and thyroid storm (where PTU's additional T4→T3 conversion blockade is beneficial).",
                a: "Propylthiouracil (PTU) does not carry a black box warning for cardiac arrhythmias. Cardiac issues are more related to the hyperthyroid state itself, not to PTU therapy.",
                c: "Propylthiouracil (PTU) is not associated with renal failure. Its primary organ toxicity concern is the liver.",
                d: "While agranulocytosis can occur with propylthiouracil (PTU), as with methimazole, the BLACK BOX warning is specifically for hepatotoxicity/liver failure, not bone marrow suppression."
            },
            testTakingTip: "Propylthiouracil (PTU) black box = LIVER FAILURE. Teach patients to report: jaundice, dark urine, light stools, abdominal pain, fatigue. Methimazole is first-line because of PTU's liver risk. PTU only for: 1st trimester pregnancy + thyroid storm.",
            guideSection: "Section 7 - Thyroid Medications",
            guideSectionId: "medications"
        },
        ...
        // Q64 - Methimazole vs PTU Comparison Matrix (Analysis, Matrix)
        {
            ...
            stem: "The nurse is comparing antithyroid medications. For each characteristic, identify whether it applies to methimazole or propylthiouracil (PTU).",
            options: [
            ...
            testTakingTip: "Methimazole vs propylthiouracil (PTU) quick compare: Methimazole = first-line, once daily, less toxic. PTU = 1st trimester pregnancy, thyroid storm, blocks peripheral conversion, but has liver black box and needs 2-3 daily doses.",
            guideSection: "Section 7 - Thyroid Medications",
            guideSectionId: "medications"
        },
        ...
        // Q65 - PTU Hepatotoxicity Response Ordering (Application, Ordering)
        {
            ...
            subtype: null,
            difficulty: "application",
            stem: "A patient on propylthiouracil (PTU) calls reporting dark urine, yellowing of the eyes, and right upper quadrant abdominal pain - signs of possible hepatotoxicity. Place the nurse's actions in the correct priority order.",
            options: [
                { id: "a", text: "Instruct the patient to STOP taking propylthiouracil (PTU) immediately" },
            ...
            correct: ["a", "b", "c", "d", "e"],
            rationale: {
                correct: "Propylthiouracil (PTU) hepatotoxicity is a Black Box Warning emergency: (1) Stop the drug immediately to prevent further liver damage, (2) Get to the ED for urgent liver function tests (LFTs) - fulminant liver failure can develop rapidly, (3) Notify the provider for medical decision-making, (4) Document everything, (5) Plan alternative therapy once the patient is stabilized.",
                a: "FIRST - Immediate drug discontinuation is the most critical action. Every additional dose of propylthiouracil (PTU) worsens the liver damage. This cannot wait for lab results or provider callback.",
                b: "SECOND - Emergency liver function testing determines the severity of hepatotoxicity. Aspartate aminotransferase (AST), alanine aminotransferase (ALT), bilirubin, international normalized ratio (INR), and albumin assess liver function. Fulminant failure can develop rapidly.",
                ...
                e: "FIFTH - Once the acute crisis is managed, the patient still needs hyperthyroidism treatment. If past the first trimester, methimazole can replace propylthiouracil (PTU). If still in the first trimester, close collaboration with endocrinology is needed."
            },
            testTakingTip: "Propylthiouracil (PTU) + jaundice/dark urine/right upper quadrant (RUQ) pain = STOP the drug FIRST, then ED for labs. Remember Jaundice, Dark urine, Abdominal pain, Light stools (JDAL). Any one of these on PTU = stop immediately.",
            guideSection: "Section 7 - Thyroid Medications",
            guideSectionId: "medications"
        },
        ...
        // Q66 - Antithyroid Medication Onset of Action (Application, Single)
        {
            ...
            rationale: {
                ...
                a: "Three days is far too early to evaluate methimazole effectiveness. Dose increases should not be considered until thyroid-stimulating hormone (TSH) is rechecked at 4-6 weeks. The current dose may be perfectly adequate.",
        ...
        // Q67 - PTU in Thyroid Storm Rationale (Analysis, Single)
        {
            ...
            subtype: null,
            difficulty: "analysis",
            stem: "In the treatment of thyroid storm, propylthiouracil (PTU) is often preferred over methimazole. Which pharmacological property of PTU makes it superior in this emergency?",
            options: [
                { id: "a", text: "Propylthiouracil (PTU) works faster in an emergency because it has a shorter half-life than methimazole." },
                { id: "b", text: "Propylthiouracil (PTU) blocks both thyroid hormone synthesis AND peripheral conversion of T4 to the more active T3, a dual mechanism." },
                { id: "c", text: "Propylthiouracil (PTU) can be given intravenously in the ICU, while methimazole is available only as a tablet." },
                { id: "d", text: "Propylthiouracil (PTU) has fewer side effects than methimazole, making it safer in the emergency setting." }
            ],
            correct: "b",
            rationale: {
                correct: "Propylthiouracil (PTU) has a unique dual mechanism: it blocks thyroid peroxidase (stopping new hormone synthesis, like methimazole) AND inhibits the peripheral conversion of T4 to T3 by type 1 deiodinase. Since T3 is 3-5 times more biologically active than T4, blocking this conversion rapidly reduces the most active form of thyroid hormone - critical in the emergency of thyroid storm.",
                a: "A shorter half-life does not equate to faster onset. Both methimazole and propylthiouracil (PTU) block synthesis at similar rates. The advantage of PTU is its ADDITIONAL mechanism of blocking T4→T3 conversion.",
                c: "Neither propylthiouracil (PTU) nor methimazole is available in standard IV formulations. Both are given orally or via nasogastric tube in thyroid storm. If the patient cannot take oral medications, rectal administration may be used.",
                d: "Propylthiouracil (PTU) actually has MORE side effects than methimazole (black box hepatotoxicity warning). Its use in thyroid storm is based on superior pharmacological activity, not safety."
            },
            testTakingTip: "Propylthiouracil (PTU) advantage in thyroid storm: blocks SYNTHESIS + blocks CONVERSION. Methimazole only blocks synthesis. In a life-threatening crisis, you want every mechanism possible to reduce active thyroid hormone.",
            guideSection: "Section 7 - Thyroid Medications",
            guideSectionId: "medications"
        },
        ...
        // Q68 - Antithyroid Medication Patient Teaching (Application, Single)
        {
            ...
            rationale: {
                ...
                d: "Methimazole does not cure Graves' disease. It controls hormone production while on the medication. Relapse rates after discontinuation are 30-70%. Many patients eventually need definitive treatment with radioactive iodine (RAI) or surgery."
            },
        ...
        // Q69 - Methimazole Monitoring (Application, Single)
        {
            ...
            options: [
                ...
                { id: "b", text: "Complete blood count (CBC) with differential, liver function tests, and thyroid function tests" },
            ...
            correct: "b",
            rationale: {
                correct: "Monitoring for methimazole includes: (1) Complete blood count (CBC) with differential - to detect agranulocytosis (white blood cell and neutrophil count), (2) Liver function tests - to monitor for hepatotoxicity, and (3) Thyroid function tests, including thyroid-stimulating hormone (TSH) and free T4, to assess treatment response and guide dose adjustments. These are essential during the first months of therapy when side effects are most likely.",
                a: "A1C and fasting glucose are diabetes monitoring tests, not relevant to antithyroid drug therapy. While hyperthyroidism can affect glucose levels, the direct medication monitoring requires complete blood count (CBC) and liver function tests (LFTs).",
            ...
            testTakingTip: "Antithyroid drug monitoring triad: Complete blood count (CBC) for agranulocytosis, liver function tests (LFTs) for hepatotoxicity, thyroid function tests (TFTs) for treatment effectiveness. Particularly important in the first 3 months when agranulocytosis risk peaks.",
            guideSection: "Section 7 - Thyroid Medications",
            guideSectionId: "medications"
        },
        ...
        // Q70 - Antithyroid Drug Pregnancy Switching Ordering (Analysis, Ordering)
        {
            ...
            options: [
                ...
                { id: "b", text: "Start propylthiouracil (PTU) at the lowest effective dose for the remainder of the first trimester" },
                ...
                { id: "e", text: "Continue methimazole for the remainder of pregnancy with regular thyroid function test (TFT) monitoring" }
            ],
            correct: ["a", "b", "c", "d", "e"],
            rationale: {
            ...
            testTakingTip: "Pregnancy antithyroid switching: 'Metro → propylthiouracil (PTU) → Metro.' Methimazole normally → PTU in 1st trimester → Methimazole back for 2nd/3rd. Switch point = week 13. Reason: methimazole teratogenic early, PTU hepatotoxic long-term.",
            guideSection: "Section 7 - Thyroid Medications",
            guideSectionId: "medications"
        },
        ...
        // Q72 - Beta-Blocker Discontinuation (Application, Single)
        {
            ...
            correct: "b",
            rationale: {
                correct: "Beta-blockers must NEVER be stopped abruptly. Sudden discontinuation can cause rebound sympathetic activation - rebound tachycardia, hypertension, and in cardiac patients, angina or myocardial infarction (MI). The dose should be gradually reduced over several days to a week. This principle applies to all beta-blockers, not just in the thyroid context.",
            ...
            testTakingTip: "NEVER stop beta-blockers abruptly - always taper. This rule applies everywhere: hypertension (HTN), heart failure, hyperthyroidism. Rebound effect = sympathetic surge → tachycardia → hypertension → potential cardiac event.",
            guideSection: "Section 7 - Thyroid Medications",
            guideSectionId: "medications"
        },
        ...
        // Q73 - Antithyroid Drug Side Effects Matrix (Analysis, Matrix)
        {
            ...
            rationale: {
                ...
                a: "REPORT IMMEDIATELY - Sore throat and fever are the hallmark warning signs of agranulocytosis. A complete blood count (CBC) with differential must be obtained urgently. Delay can be fatal.",
                ...
                c: "REPORT IMMEDIATELY - Jaundice and dark urine indicate hepatotoxicity. While more common with propylthiouracil (PTU), it can also occur with methimazole. Liver function tests and drug discontinuation may be needed.",
                ...
                e: "REPORT IMMEDIATELY - Unusual bleeding or bruising may indicate thrombocytopenia (low platelets) or other blood dyscrasias associated with antithyroid drugs. A complete blood count (CBC) is needed promptly."
            },
            testTakingTip: "Antithyroid drug urgent symptoms: Sore Throat, Jaundice, Bleeding/Bruising (STJ-BB). These signal agranulocytosis, liver failure, or thrombocytopenia. Mild rash and joint pain = monitor but don't panic.",
            guideSection: "Section 7 - Thyroid Medications",
            guideSectionId: "medications"
        },
        ...
        // Q74 - PTU in Pregnancy First Trimester (Application, Single)
        {
            ...
            subtype: null,
            difficulty: "application",
            stem: "A pregnant patient at 10 weeks gestation is diagnosed with hyperthyroidism requiring treatment. The provider prescribes propylthiouracil (PTU) instead of methimazole. Which explanation by the nurse BEST describes why PTU is preferred at this stage?",
            options: [
                { id: "a", text: "Propylthiouracil (PTU) is more effective than methimazole at controlling hyperthyroidism in every stage of pregnancy." },
                { id: "b", text: "Methimazole can cause birth defects (aplasia cutis, choanal atresia) in the first trimester, while propylthiouracil (PTU) is safer in early pregnancy." },
                { id: "c", text: "Propylthiouracil (PTU) does not cross the placenta at all, making it completely safe for the fetus throughout the pregnancy." },
        ...
        // Q75 - Antithyroid Drugs: Correct vs Needs Teaching Matrix (Analysis, Matrix)
        {
            ...
            rationale: {
                ...
                a: "CORRECT UNDERSTANDING - Sore throat and fever are the critical warning signs of agranulocytosis. Immediate reporting allows for urgent complete blood count (CBC) testing and potential drug discontinuation.",
            ...
            testTakingTip: "Dismissing sore throat on antithyroid drugs = most dangerous patient misconception. It's never 'just a cold' until agranulocytosis is ruled out with a complete blood count (CBC).",
            guideSection: "Section 7 - Thyroid Medications",
            guideSectionId: "medications"
        },
        ...
        // Q76 - Lugol's Solution Administration (Application, Single)
        {
            ...
            correct: "b",
            rationale: {
                correct: "Lugol's solution has a strong, bitter, metallic taste that can cause significant gastrointestinal (GI) upset. Proper administration includes: (1) diluting in water or juice to mask the taste, (2) using a straw to minimize contact with oral mucous membranes, (3) taking with food to decrease GI upset, and (4) rinsing the mouth afterward. These techniques improve tolerance and compliance.",
                a: "Undiluted Lugol's solution is extremely bitter and causes significant gastrointestinal (GI) upset. It should always be diluted. Empty stomach administration increases nausea and vomiting.",
            ...
            testTakingTip: "Lugol's solution: Dilute + Straw + Food + Rinse. Think Dilute, Straw, Food, Rinse (DSFR): Dilute in juice, Straw to bypass taste buds, Food to prevent gastrointestinal (GI) upset, Rinse mouth after. The straw minimizes the bitter metallic taste.",
            guideSection: "Section 7 - Thyroid Medications",
            guideSectionId: "medications"
        },
        ...
        // Q78 - Radioactive Iodine Expected Outcome (Application, Single)
        {
            ...
            correct: "c",
            rationale: {
                correct: "This statement shows misunderstanding. Radioactive iodine (RAI) destroys thyroid tissue, which means the patient will almost certainly develop HYPOTHYROIDISM and will need LIFELONG levothyroxine replacement. Not needing medication 'ever again' is incorrect - the medication changes from antithyroid drugs to thyroid replacement. Statements A, B, and D are all accurate.",
                a: "ACCURATE - The expected outcome of radioactive iodine (RAI) is hypothyroidism, requiring lifelong levothyroxine. This is considered a therapeutic success, not a complication.",
                ...
                d: "ACCURATE - Radioactive iodine (RAI) takes weeks to months for full effect. The thyroid cells are gradually destroyed by radiation over time. Some patients require a second dose."
            },
            testTakingTip: "Radioactive iodine (RAI) 'cures' hyperthyroidism by creating hypothyroidism. The patient trades one condition for another - but hypothyroidism is much easier to manage (one daily pill). Key teaching: expect lifelong levothyroxine.",
            guideSection: "Section 7 - Thyroid Medications",
            guideSectionId: "medications"
        },
        ...
        // Q79 - RAI Radiation Precautions Ordering (Application, Ordering)
        {
            ...
            correct: ["a", "b", "c", "d", "e"],
            rationale: {
                correct: "Radioactive iodine (RAI) precautions are prioritized by radiation sensitivity of those at risk: (1) Pregnant women and children are most radiosensitive, (2) Close/intimate contact transmits the most radiation, (3) Body fluids (urine, saliva) contain concentrated I-131, (4) Shared utensils can transfer contaminated saliva, (5) Increased fluids speed elimination and reduce radiation exposure time.",
            ...
            testTakingTip: "Radioactive iodine (RAI) precaution priority: Protect the MOST VULNERABLE first (pregnant women, children), then minimize DOSE to others (distance, separate items), then SPEED elimination (fluids). Think: People → Distance → Excretion.",
            guideSection: "Section 7 - Thyroid Medications",
            guideSectionId: "medications"
        },
        ...
        // Q80 - RAI Contraindications (Knowledge, Single)
        {
            ...
            correct: "b",
            rationale: {
                correct: "Pregnancy is an ABSOLUTE contraindication for radioactive iodine (RAI) therapy. I-131 crosses the placenta and concentrates in the fetal thyroid, causing irreversible destruction of fetal thyroid tissue and permanent congenital hypothyroidism. Breastfeeding is also contraindicated because I-131 is secreted in breast milk. A pregnancy test is required before RAI administration, regardless of the patient's stated pregnancy status.",
                a: "While diabetes may coexist with thyroid disease, A1C is not relevant to radioactive iodine (RAI) safety. The critical pre-treatment screening is for pregnancy.",
                ...
                d: "A dental exam is not a prerequisite for radioactive iodine (RAI) therapy. Some sources recommend dental work be done before RAI to avoid radiation exposure to the oral cavity during dental procedures, but this is not the critical safety check."
            },
            testTakingTip: "Radioactive iodine (RAI) absolute contraindications: Pregnancy and Breastfeeding. ALWAYS pregnancy test before RAI - no exceptions. Fetal thyroid destruction is permanent. Also: must not plan pregnancy for 6-12 months after RAI.",
            guideSection: "Section 7 - Thyroid Medications",
            guideSectionId: "medications"
        },
        ...
        // Q81 - RAI Treatment Timeline Ordering (Application, Ordering)
        {
            ...
            options: [
                { id: "a", text: "Obtain negative pregnancy test and discontinue antithyroid drugs 3-5 days before radioactive iodine (RAI)" },
                ...
                { id: "e", text: "Start lifelong levothyroxine replacement once hypothyroidism is confirmed by elevated thyroid-stimulating hormone (TSH)" }
            ],
            correct: ["a", "b", "c", "d", "e"],
            rationale: {
                correct: "Radioactive iodine (RAI) treatment follows a predictable timeline: (1) Pre-treatment safety screening and drug washout, (2) RAI administration with radiation precautions, (3) Transient worsening in the first 1-2 weeks from stored hormone release, (4) Hypothyroidism developing over weeks to months as thyroid tissue is destroyed, (5) Lifelong levothyroxine to replace the now-absent thyroid function.",
                a: "FIRST - Pregnancy testing is mandatory because radioactive iodine (RAI) is absolutely contraindicated in pregnancy. Antithyroid drugs are held briefly to maximize thyroid iodine uptake for effective treatment.",
                ...
                e: "FIFTH - Once thyroid-stimulating hormone (TSH) is confirmed elevated and the patient is symptomatic, levothyroxine is initiated. This is lifelong therapy. Post-radioactive iodine (RAI) hypothyroidism = treatment SUCCESS, not failure."
            },
            testTakingTip: "Radioactive iodine (RAI) timeline: Pregnancy test → Single dose → Symptoms briefly WORSE (stored hormone release) → Hypothyroidism develops (weeks-months) → Lifelong levothyroxine. The patient trades hyperthyroidism for manageable hypothyroidism.",
            guideSection: "Section 7 - Thyroid Medications",
            guideSectionId: "medications"
        },
        ...
        // Q82 - Iodine Solution Timing in Thyroid Storm (Analysis, Single)
        {
            ...
            subtype: null,
            difficulty: "analysis",
            stem: "In the treatment of thyroid storm, Lugol's solution (iodine) must be administered at least 1 hour AFTER propylthiouracil (PTU) or methimazole. If iodine is given FIRST, the MOST dangerous consequence would be:",
            options: [
            ...
            testTakingTip: "Propylthiouracil (PTU) BEFORE iodine - ALWAYS. Think: 'Block the factory BEFORE delivering raw materials.' If you deliver iodine to a factory with no brake on production, it makes MORE product. 1-hour minimum gap.",
        ...
        // Q84 - Lugol's Solution Side Effects (Knowledge, Single)
        {
            ...
            correct: "b",
            rationale: {
                correct: "Iodism is the term for chronic iodine toxicity. Classic symptoms include: metallic taste, burning in the mouth and throat, hypersalivation, sore gums and mucous membranes, skin rash, gastrointestinal (GI) upset, and in severe cases, productive cough and swollen salivary glands. These symptoms should be reported because the provider may need to adjust or discontinue the iodine therapy.",
        ...
        // Q85 - Thyroid Medication Mechanisms Ordering (Analysis, Ordering)
        {
            ...
            options: [
                { id: "a", text: "Thionamides such as methimazole or propylthiouracil (PTU) - blocks thyroid peroxidase and new hormone synthesis" },
            ...
            rationale: {
                ...
                a: "FIRST (Block Synthesis) - Methimazole and propylthiouracil (PTU) inhibit thyroid peroxidase, the enzyme needed to organify iodine and couple iodotyrosines. This stops NEW hormone production. PTU additionally blocks peripheral T4→T3 conversion.",
        ...
        // Q86 - Thyroid Storm Recognition (Analysis, Single - Priority)
        {
            ...
            correct: "b",
            rationale: {
                correct: "This is a classic thyroid storm presentation: extreme fever (>104°F), severe tachycardia with possible atrial fibrillation, hypertension, agitation, confusion, and diaphoresis - triggered by a urinary tract infection (UTI) in a patient with known Graves' disease. This is a medical emergency with 20-30% mortality requiring ICU management with propylthiouracil (PTU), iodine, beta-blockers, corticosteroids, cooling measures, and treatment of the precipitating infection.",
        ...
        // Q87 - Thyroid Storm Triggers Matrix (Knowledge, Matrix)
        {
            ...
            rationale: {
                correct: "Thyroid storm triggers include medication discontinuation, unprepared thyroid surgery, diabetic ketoacidosis (DKA), and severe stress/trauma. Regular moderate exercise is not a recognized trigger.",
                a: "KNOWN TRIGGER - Abruptly stopping antithyroid medications such as methimazole or propylthiouracil (PTU) causes a rebound surge in thyroid hormone production that can precipitate thyroid storm.",
                ...
                d: "KNOWN TRIGGER - Diabetic ketoacidosis (DKA) and other severe metabolic stressors can precipitate thyroid storm in susceptible patients. The physiological stress triggers a massive thyroid hormone surge.",
        ...
        // Q88 - Thyroid Storm Treatment Sequence Ordering (Analysis, Ordering)
        {
            ...
            options: [
                { id: "a", text: "Administer propylthiouracil (PTU) to block thyroid hormone synthesis and peripheral T4→T3 conversion" },
                { id: "b", text: "Administer Lugol's solution 1 hour after propylthiouracil (PTU) to block hormone release" },
        ...
        // Q90 - Thyroid Storm Cardiac Complications (Analysis, Single)
        {
            ...
            rationale: {
                ...
                c: "While infection may have triggered the thyroid storm, the specific triad of crackles + jugular venous distention (JVD) + S3 points to cardiac failure rather than pneumonia. Pneumonia would more likely present with productive cough, focal crackles, and infiltrates on chest X-ray.",
            ...
            testTakingTip: "Crackles + jugular venous distention (JVD) + S3 = heart failure - regardless of the underlying cause. In thyroid storm, the heart can't keep up with the extreme metabolic demand. This is why cardiac monitoring is continuous and beta-blockers are given early.",
            guideSection: "Section 6 - Thyroid Storm",
            guideSectionId: "thyroid-storm"
        },
        ...
        // Q91 - Thyroid Storm vs Severe Hyperthyroidism (Analysis, Single)
        {
            ...
            options: [
                ...
                { id: "d", text: "A suppressed, nearly undetectable thyroid-stimulating hormone (TSH) level on laboratory testing" }
            ],
            correct: "c",
            rationale: {
                correct: "Thyroid storm is distinguished from severe hyperthyroidism by the presence of extreme hyperthermia (>104°F), altered mental status (agitation → delirium → coma), and multiorgan dysfunction (cardiac, gastrointestinal, neurological). T3/T4 levels may be similar to uncomplicated hyperthyroidism - thyroid storm is a CLINICAL diagnosis based on the severity of end-organ manifestations, not just lab values.",
                ...
                d: "Low thyroid-stimulating hormone (TSH) is present in all forms of primary hyperthyroidism, from mild to thyroid storm. It does not differentiate the severity of the clinical presentation."
            },
        ...
        // Q92 - Post-Thyroid Storm Monitoring (Application, Single)
        {
            ...
            options: [
                ...
                { id: "d", text: "Thyroid-stimulating hormone (TSH) level rising slightly from 0.01 to 0.05 mIU/L on the morning laboratory panel after 48 hours" }
            ],
            correct: "a",
            rationale: {
                ...
                d: "A thyroid-stimulating hormone (TSH) change from 0.01 to 0.05 is clinically insignificant. TSH takes weeks to months to normalize after resolving hyperthyroidism. Clinical response is assessed by vital signs and symptoms, not TSH in the acute setting."
            },
            testTakingTip: "Thyroid storm improvement = vital signs trending toward normal: HR decreasing, temp decreasing, mental status improving. Don't rely on thyroid-stimulating hormone (TSH) - it's too slow to reflect acute changes. Monitor clinical response.",
            guideSection: "Section 6 - Thyroid Storm",
            guideSectionId: "thyroid-storm"
        },
        ...
        // Q93 - Corticosteroids in Thyroid Storm Rationale (Knowledge, Single)
        {
            ...
            rationale: {
                ...
                d: "Corticosteroids do not prevent hypothyroidism. Post-crisis hypothyroidism depends on definitive treatment with radioactive iodine (RAI) or surgery and is managed with levothyroxine."
            },
        ...
        // Q95 - Thyroid Storm vs Myxedema Coma Treatment Matrix (Analysis, Matrix)
        {
            ...
            options: [
                { id: "a", text: "Propylthiouracil (PTU) or methimazole (antithyroid drugs)" },
            ...
            rationale: {
                ...
                e: "THYROID STORM - Lugol's iodine blocks hormone RELEASE and is given after propylthiouracil (PTU) blocks synthesis. In myxedema coma, the goal is the opposite: to restore hormone levels."
            },
        ...
        // Q99 - Post-Thyroidectomy Comprehensive Care Ordering (Analysis, Ordering)
        {
            ...
            subtype: null,
            difficulty: "analysis",
            stem: "A nurse receives a patient from the post-anesthesia care unit (PACU) after total thyroidectomy. Place the following post-operative nursing assessments in the correct priority order.",
            options: [
            ...
            testTakingTip: "Post-thyroidectomy assessment priority: Airway, Bleeding, Voice, Calcium, Equipment (ABVCE). The four complications to watch for: Hemorrhage, Laryngeal nerve damage, Hypocalcemia, Thyroid storm.",
            guideSection: "Section 9 - Thyroidectomy Nursing Care",
            guideSectionId: "thyroidectomy"
        },
